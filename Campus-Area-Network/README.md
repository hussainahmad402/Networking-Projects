...
### Requirements:<br>
a. Create a network topology with the main components to support the following: <br>
<b>Main campus:</b><br>
...
<b>• Building B:</b> Faculty of Engineering and Computing and Faculty of Art and Design
